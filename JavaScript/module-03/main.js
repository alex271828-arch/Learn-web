...
//   if (string[i] === " ") wordCounter += 1;
//   if (i === 1) wordCounter += 1;
// }
// console.log(wordCounter);

/*
Задача: Знайти суму чисел в діапазоні, що кратні 3 та 5
Опис:
Користувач вводить два числа, які визначають діапазон. Програма повинна знайти всі числа в цьому діапазоні, що кратні 3 та 5, та обчислити їхню суму. Після цього програма виводить результат.
...
Алгоритм:
1. створити змінні для діапазону чисел
2. створюємо змінну де будемо зберігати накопичену суму
3. запускаємо цикл для перебору кожного числа в діапазоні
4. робимо перевірку кожного числа, якщо воно ділиться націло на 3 і на 5 воно нам підходить
5. якщо число ділиться, то додаємо його до змінної суми (крок 2)
*/
